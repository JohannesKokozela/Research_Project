...
theta_update,cost = logistic_regression_train(theta,X_train,Y_train)

print('Minimum cost :' , np.min(cost), 'iteration number', np.argmin(cost))
...
theta_update.tofile('Logistic_weights1.csv',sep = ',')
